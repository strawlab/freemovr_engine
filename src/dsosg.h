...
namespace dsosg{
    ...
    public:
        ...
        std::string stimulus_get_output_topic_name(const std::string& plugin_name);
        std::string stimulus_get_output_message_type(const std::string& plugin_name);
        std::string get_output_message_json();
