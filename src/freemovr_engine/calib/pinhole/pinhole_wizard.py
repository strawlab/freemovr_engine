...
import freemovr_engine.fill_polygon as fill_polygon
import freemovr_engine.exr as exr
from freemovr_engine.fit_extrinsics import fit_extrinsics, fit_extrinsics_iterative
from freemovr_engine.calib.pinhole.widgets import CellRendererButton
...
class UI(object):
    def __init__(self):
        ui_file_contents = pkgutil.get_data('freemovr_engine.calib.pinhole','pinhole-wizard.ui')
    ...
    def _build_ui(self):
        ...
        version_str = getattr(freemovr_engine,'__version__','0.0')
